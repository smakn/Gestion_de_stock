...
if (
    ...
    $sql = "INSERT INTO articles(Nom_article, categorie, quantite, prix_unitaire, date_fabrication, date_expiration)
    VALUES (?, ?, ?, ?, ?, ?)   "; 
...
//message a afficher dans article apres l enregistrement
    if ($req ->rowCount()!=0) {
        ...
        $_SESSION['message']['text'] = "Une erreur a été détecté lors de l'ajout de l article:";
